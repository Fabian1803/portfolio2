...
export default function Footer() {
    ...
    return (
        <footer className="pt-5 pr-[5%] sm:pr-[10%] pb-5 pl-[5%] sm:pl-[10%]" >
            <div className=" grid sm:grid-cols-[70%,30%]">
                <div className="">
                    <motion.h2 {...AnimationLeft(isSmallScreen)}
                        className="h-auto text-[clamp(1rem,_9vw,_10rem)] sm:text-[clamp(3rem,_4.5vw,_5rem)] font-bold leading-[90%] pb-9">
                            Let&apos;s work together
                    </motion.h2>
                    <motion.button
                        whileInView={{x: [50, 0]}}
                        transition={{ duration: 1}}
                        className="bg-secondary pr-5 pl-5 pt-2 pb-2 rounded-md border-2 border-solid border-quaternary font-bold">
                ...
                <motion.div {...AnimationRight(isSmallScreen)} className="flex flex-col mt-10 mb-10 sm:m-0">
                    <h3 className='text-[22px] font-bold '>Social networks</h3>
            ...
            <motion.div 
            {...AnimationUp1}
            className=" text-[clamp(2rem,_12vw,_15rem)] sm:text-[clamp(4rem,_11vw,_15rem)] text-center font-bold tracking-4">Fabian Rivera</motion.div>
