            ...
            <section className="pt-5 sm:pt-16 pr-[5%] sm:pr-[10%] pb-5 sm:pb-16 pl-[5%] sm:pl-[10%] flex flex-col gap-16 overflow-hidden" id="about">
                <div className="grid md:grid-cols-[50%,50%] items-center">
                    ...
                    <motion.div {...AnimationRight(isSmallScreen)} className="gap-3 flex flex-col">
                        <p className="text-justify">Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó una galería de textos y los mezcló de tal manera que logró hacer un libro de textos especimen. No sólo sobrevivió 500 años, sino que tambien ingresó como texto de r</p>
                        <p className="text-justify">elleno en documentos electrónicos, quedando esencialmente igual al original. Fue popularizado en los 60s con la creación de las hojas "Letraset", las cuales contenian pasajes de Lorem Ipsum, y más recientemente con software de autoedición, como por ejemplo Aldus PageMaker, el cual incluye versiones de Lorem Ipsum.</p>
                    </motion.div>
                </div>
                <div className="grid md:grid-cols-[50%,50%] items-center">
